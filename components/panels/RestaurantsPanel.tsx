...
export default function RestaurantsPanel({ restaurants }: RestaurantsPanelProps) {
  return (
    <motion.div 
      ...
      {restaurants.map((restaurant, index) => (
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <span className="text-sm text-[#4A4A4A] bg-[#F6F4E9]/60 px-3 py-1 rounded-full">
              📍 {restaurant.location}
            </span>
          </div>
